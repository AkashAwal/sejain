...
export default function Button({
  ...
  return (
    <Link
      className={`group relative inline-flex items-center justify-center overflow-hidden bg-primary px-6 py-3 text-sm font-semibold uppercase tracking-wider text-white transition-colors duration-300 ${className}`}
      {...props}
    >
